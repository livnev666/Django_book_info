...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('book_app', '0005_book_publisheddate'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_book', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commentuser_book', to='book_app.book', verbose_name='Книга')),
